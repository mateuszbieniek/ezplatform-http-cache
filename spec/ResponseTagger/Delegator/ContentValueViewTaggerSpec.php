...
use EzSystems\PlatformHttpCacheBundle\ResponseTagger\Delegator\ContentValueViewTaggerInterface;
...
class ContentValueViewTaggerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ContentValueViewTaggerInterface::class);
    }
