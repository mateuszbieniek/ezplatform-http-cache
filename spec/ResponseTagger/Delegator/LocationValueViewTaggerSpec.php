...
use EzSystems\PlatformHttpCacheBundle\ResponseTagger\Delegator\LocationValueViewTaggerInterface;
...
class LocationValueViewTaggerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(LocationValueViewTaggerInterface::class);
    }
